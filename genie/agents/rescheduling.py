...
class ReschedulingAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "   b. send_message to the sub (sms) notifying them of the new date\n"
            "   c. update_job_status → 'rescheduled'\n"
            ...
            "   d. send_message to the backup (sms) with the job details\n"
            "   e. update_job_status → 'rescheduled'\n"
